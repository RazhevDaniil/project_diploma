...
DEFAULT_MANAGED_RAG_KB_VERSION = "latest"
LEGACY_DEFAULT_MANAGED_RAG_KB_VERSIONS = {
    "eb73eb63-ec91-47c9-851e-1c14949b7a14",
}
MANAGED_RAG_URL = os.getenv(
    "MANAGED_RAG_URL",
    "https://e424a162-618c-4862-b789-b089abd81b46.managed-rag.inference.cloud.ru/api/v2/retrieve",
)
MANAGED_RAG_KB_VERSION = os.getenv("MANAGED_RAG_KB_VERSION", DEFAULT_MANAGED_RAG_KB_VERSION)
